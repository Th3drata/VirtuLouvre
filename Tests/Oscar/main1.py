...
buttons_menu = [
    Button(300, 200, 200, 50, "Resume", WHITE, FONT, BLUE, HOVER_BLUE),
    Button(300, 270, 200, 50, "Settings", WHITE, FONT, BLUE, HOVER_BLUE),
    Button(300, 340, 200, 50, "Quit", WHITE, FONT, BLUE, HOVER_BLUE),
]
...
def start_game(screen, font, background_image, dimensions_possibles):
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    if current_state == "game":
                        current_state = "game_menu"  # Ouvrir le menu pause
                        pygame.mouse.set_visible(True)
                    elif current_state == "game_menu":
                        current_state = "game"  # Reprendre le jeu
                        pygame.mouse.set_visible(False)
                    elif current_state == "settings":
                        current_state = "game_menu"  # Retour au menu pause après les paramètres
    ...
    # Fond semi-transparent
            pygame.draw.rect(screen, (0, 0, 0, 180), (0, 0, screen.get_width(), screen.get_height()))
    # Affichage des boutons du menu pause
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                bar_y = 300
                bar_width = 420
                if bar_x <= mouse_x <= bar_x + bar_width and bar_y - 10 <= mouse_y <= bar_y + 30:
                    is_dragging = True
                ...
                relative_x = mouse_x - 200
                slider_value = 70 + (relative_x / 420) * 80
                slider_value = max(70, min(150, slider_value))  # Clamping
