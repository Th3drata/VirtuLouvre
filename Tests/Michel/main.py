...
from utils import grid, draw_fps, draw_position, draw_view_angle, load_obj, load_mtl, load_texture, create_model_vbo, draw_model_vbo
...
def main():
    ...
    player = Player(45, (windowed_size[0] / windowed_size[1]), 0.1, 200)
