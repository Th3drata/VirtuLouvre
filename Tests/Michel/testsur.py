...
def start_game(screen, font, background_image, current_state):
    if current_state == "game":
        ...
        while True:
            ...
            if current_state == "game_menu":
                ...
                # Define buttons
                buttons1 = [
                    Button(screen_width // 2 - 100, 200, 200, 50, "Resume", font, blue, hover_blue),
                ...
                # Slider bar
                bar_x, bar_y = screen_width // 2 - 210, 300  # Position of the slider
                ...
                value_rect = value_surface.get_rect(center=(screen_width // 2, 250))
...
def main_menu():
    ...
    while running:
        ...
        if current_state == "parametres":
            ...
            start_game(screen, font, game_background, current_state)
            pygame.display.flip()
