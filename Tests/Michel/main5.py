    ...
    if current_state == "game":
        ...
        while True:
            ...
            for event in pygame.event.get():  # Pour chaque événement Pygame
                ...
                if current_state != "game_menu":  # Si le menu est fermé
            ...
            if current_state == "game_menu":
                ...
                # Define buttons relative to surface
                buttons = [
                    Button(screen.get_width()//2-100, screen.get_height()//2-60, 200, 50, "Resume", (255,255,255), font, (0,0,150), (0,0,200)),
                    Button(screen.get_width()//2-100, screen.get_height()//2+20, 200, 50, "Settings", (255,255,255), font, (0,0,150), (0,0,200)),
                    Button(screen.get_width()//2-100, screen.get_height()//2+100, 200, 50, "Quit", (255,255,255), font, (0,0,150), (0,0,200)),
                ]
